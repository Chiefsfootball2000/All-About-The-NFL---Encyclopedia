...
const rules = [
	...
	"A sack occurs when a QB is tackled behind the line.",
	...
	"A 3rd down conversion is critical for 1st down.",
	"Incomplete passes stop the clock.",
	"Interceptions can be returned for a touchdown.",
	"Punts are used to change field position.",
	"Touchbacks occur on certain kicks.",
	"Challenges allow coaches to contest calls.",
